...
fontLoader.load(
    ...
    (font) =>
    {
        ...
        for (let i = 0; i < 100; i++) {
            const donoutGeometry = new THREE.TorusGeometry(0.3, 0.2, 45)
            const donoutMaterial = new THREE.MeshMatcapMaterial({ matcap: matcapTexture })  
            const donout = new THREE.Mesh(donoutGeometry, donoutMaterial)
